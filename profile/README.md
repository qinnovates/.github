...
| **TARA** | 102 attack-therapy technique pairs across 8 domains and 15 tactics. STIX 2.1 registry. | [Registry](https://qinnovate.com/TARA/) · [STIX Feed](https://qinnovate.com/api/stix.json) |
...
|----------|----------------|
| [`/api/tara.json`](https://qinnovate.com/api/tara.json) | All 102 techniques with CVSS v4.0 vectors, NISS scores, DSM-5-TR diagnostic mappings, physics feasibility constraints, therapeutic analogs, FDA status, safe dosing parameters, governance requirements, and engineering specs. |
...
- **TARA Registry:** [102 BCI attack-therapy technique pairs](https://qinnovate.com/TARA/)
